...
class CreateUser extends Component {
  ...
  submitHandler = (event) => {
    ...
    // this.props.refreshHandler(user);  
    var lang = 'refresh';
    this.props.refreshHandler(lang);
  }
  modalHandler = (e) => {
    e.preventDefault();
    this.setState({ isModalOpen: false });
        ...
        <nav className="navbar navbar-light d-flex justify-content-end">
          <div>
            <form className="form-inline text-right">
              ...
              <button className="btn btn-outline-success" onClick={this.createUserHandler}>Create user</button>
            </form>
          </div>
        </nav>
        <Modal
